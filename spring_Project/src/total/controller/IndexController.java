...
public class IndexController {
	...
	public String indexHandle(Model model) {
		...
		System.out.println(boardService.mongoFindImage(1));  
		
		/*
		System.out.println(boardService.mongoFindImage(boardNo.get(0).get("NO")));
		...
		*/
		...
		//application.getRealPath("/image")+"/Desert";
		return "t_el";
