...
<div class="container-fluid text-center">
	...
	<div class="row">
		<div class="col-sm-3">
			<h4>
				<a
					href="${pageContext.request.contextPath }/board/listPage?stype=세계여행">세계여행</a>
			</h4>
		</div>
		<div class="col-sm-3">
			<h4>
				<a
					href="${pageContext.request.contextPath }/board/listPage?stype=글쓰기">글쓰기</a>
			</h4>
		</div>
		<div class="col-sm-3">
			<h4>
				<a
					href="${pageContext.request.contextPath }/board/listPage?stype=문화·예술">문화·예술</a>
			</h4>
		</div>
		<div class="col-sm-3">
			<h4>
				<a
					href="${pageContext.request.contextPath }/board/listPage?stype=사랑·이별">사랑·이별</a>
			</h4>
		</div>
	...
	<div class="row">
		<div class="col-sm-3">
			<h4>
				<a
					href="${pageContext.request.contextPath }/board/listPage?stype=직장인 현실조언">직장인
					현실조언</a>
			</h4>
		</div>
		<div class="col-sm-3">
			<h4>
				<a
					href="${pageContext.request.contextPath }/board/listPage?stype=건축·설계">건축·설계</a>
			</h4>
		</div>
		<div class="col-sm-3">
			<h4>
				<a
					href="${pageContext.request.contextPath }/board/listPage?stype=시사·이슈">시사·이슈</a>
			</h4>
		</div>
		<div class="col-sm-3">
			<h4>
				<a
					href="${pageContext.request.contextPath }/board/listPage?stype=시사·이슈">쉽게읽는
					역사</a>
			</h4>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-sm-3">
			<h4>
				<a
					href="${pageContext.request.contextPath }/board/listPage?stype=육아이야기">육아이야기</a>
			</h4>
		</div>
		<div class="col-sm-3">
			<h4>
				<a
					href="${pageContext.request.contextPath }/board/listPage?stype=요리·레시피">요리·레시피</a>
			</h4>
		</div>
		<div class="col-sm-3">
			<h4>
				<a
					href="${pageContext.request.contextPath }/board/listPage?stype=건강·운동">건강·운동</a>
			</h4>
		</div>
		<div class="col-sm-3">
			<h4>
				<a
					href="${pageContext.request.contextPath }/board/listPage?stype=건강·운동">우리집
					반려동물</a>
			</h4>
		</div>
