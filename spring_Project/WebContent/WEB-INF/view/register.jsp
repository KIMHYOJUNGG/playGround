	...
	<div align="center">
			<form action="/member/regist" method="post"
					...
					<p>
						...
						<div id="idc">${idmsg }</div>
					</p>
					<p>
						<b>PASS(*)</b><br/><input type="password" name="password" id="password">
						<div id="passc">${passwordmsg }</div>
					</p>
					<p>
					</p>
						<b>REPASS(*)</b><br/><input type="password" name="repassword" id="repass" onblur="checkps();"><br/>
						<span id="rgd2"></span>
					<p>
					<p>
